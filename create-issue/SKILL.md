---
name: create-issue
description: Capture bugs, features, or improvements quickly while the user is mid-development. Create complete issues with all necessary details in under 2 minutes.
---
