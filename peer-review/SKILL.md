---
name: peer-review
description: Have different models review each other's work. I'll have Codex or Gemini review code that Claude wrote, then bring that feedback back. The dev lead verifies each finding rather than accepting blindly.
---
